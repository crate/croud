...
- Added the commands ``croud monitoring grafana enable`` and
  ``croud monitoring grafana disable`` These commands are used to enable
  and disable a Grafana dashboard for a project.
